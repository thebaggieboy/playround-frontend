          ...
          <div className="relative overflow-hidden">
            ...
            <div className="flex animate-[scroll_25s_linear_infinite]">
              {[...logoNames, ...logoNames].map((name, i) => (
                <div
                  key={i}
                  className="flex-shrink-0 mx-8 flex items-center gap-2 px-6 py-3 rounded-lg border border-[#e8e4df] bg-[#faf9f7]"
                >
                  <div className="w-8 h-8 rounded-md bg-[#f0ece7] flex items-center justify-center">
          ...
          {trustBadges.map((badge, index) => {
            ...
            return (
              <motion.div
                ...
                className="flex items-center gap-3 p-4 rounded-xl border border-[#e8e4df] bg-[#faf9f7] hover:border-blue-200 hover:bg-white transition-all duration-300"
              >
