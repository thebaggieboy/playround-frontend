...
export function Hero() {
  return (
    <section className="relative py-20 md:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden bg-[#0f1b3d]">
      ...
      <div className="absolute top-20 right-0 w-[480px] h-[480px] rounded-full bg-[#1a3264]/40 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[320px] h-[320px] rounded-full bg-[#162d5a]/50 blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="absolute inset-0 rounded-xl overflow-hidden border border-[#264a82] bg-[#0c1630] shadow-2xl shadow-blue-950/30">
              <video
